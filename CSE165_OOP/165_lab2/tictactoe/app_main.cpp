...
void checkGameState(vector<Rect> grid)
{
    ...
    {
        cout << "X wins" << endl;
        //drawString(GLUT_BITMAP_HELVETICA_18, "Player1 wins!", 0,0);
        
        gameOver = true;
    }
    if (winO(grid)){
        cout << "O wins" << endl;
        //  drawString(GLUT_BITMAP_HELVETICA_18, "Player2 wins!", 0, 0);
        gameOver = true;
    }
    ...
    if (!gameOver){
        ...
        if (flag){
            ...
            //  drawString(GLUT_BITMAP_HELVETICA_18, "tie", 0, 0);
...
void appDrawScene() {
    ...
    {
        //cout << "X wins" << endl;
        drawString(GLUT_BITMAP_HELVETICA_18, "Player1 wins!", -0.15,0.90);
    ...
    {
      //  cout << "X wins" << endl;
        drawString(GLUT_BITMAP_HELVETICA_18, "Player2 wins!", -0.15,0.90);
...
int main(int argc, char** argv) {
    cout << "press '1' one player or '2' for two players ";
    cin >> twoplayergame;
    if (twoplayergame == 2)
    {
        ai = false;
